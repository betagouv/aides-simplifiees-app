...
const styleVariants: Record<StyleVariantName, Record<string, string>> = {
  ...
  'light-contrast': {
    'brand-gradient-overlay':
      'linear-gradient(90deg, #000091 10%, rgba(0, 0, 145, 0.25) 65%, rgba(225, 0, 15, 0.05) 100%)',
...
const styleVariantName = computed<StyleVariantName>(() => {
  return contrast.value ? `${theme.value}-contrast` : theme.value
})
...
const waves: WaveDefinition[] = [
  {
    ...
    waves: {
      ...
      middle:
        'M1920 83.6278V200.5H0V87.3417C74.5881 93.4705 149.203 99.6291 223.737 105.741C313.85 113.075 400.616 120.051 492.246 122.884C565.033 125.179 638.903 124.54 710.985 120.349C875.564 111.657 1019.84 80.1396 1188.57 77.729C1317.67 75.0927 1440.69 87.9295 1564.85 95.336C1693.7 103.13 1797.35 96.4093 1920 83.6278Z',
      bottom:
        'M1920 192.848V200.496H0V182.302C150.91 181.38 298.068 181.992 447.312 175.952C548.451 171.998 649.198 165.118 747.181 156.526C863.71 146.192 974.807 136.814 1094.76 140.756C1286.85 145.517 1446.94 185.33 1633.68 196.428C1668.72 198.514 1704.42 199.584 1739.98 199.609C1800.78 199.75 1862.03 196.386 1920 192.848Z',
    },
  },
  {
    name: 'sm',
...
<template>
  <div
    ...
    :class="[`waves-container--${wave.name}`]"
    :style="{
