  ...
  <DefaultLayout>
    <BrandBackgroundContainer textured contrast>
      <SectionContainer type="page-header">
        <h1 class="brand-contrast-text"><br />Administration des aides</h1>
      </SectionContainer>
                    ...
                    <div class="fr-col-12 fr-col-md-8">
                      ...
                      <p class="fr-mb-0 badges-row">
                        <span class="fr-badge fr-badge--sm fr-badge--blue-cumulus fr-mr-1w"
                          >#{{ aide.id }}</span
                        >
                        <span v-if="aide.type" class="fr-badge fr-badge--green-emeraude fr-mr-1w">{{
                          aide.type
                        }}</span>
                        <span
                      ...
                      <p class="fr-mb-0">
                        ...
                        <span class="fr-text--sm fr-text--italic"
                          >Mise à jour: {{ new Date(aide.updatedAt).toLocaleDateString() }}</span
                        >
                      </p>
                    </div>
