...
const form = useForm({
  title: props.aide.title,
  content: props.aide.content,
  description: props.aide.description || '',
...
const handleSubmit = () => {
  form.post(`/admin/aides/${props.aide.id}`)
}
</script>

<template>
  <Head :title="`Modifier - ${aide.title} | Admin`" />
