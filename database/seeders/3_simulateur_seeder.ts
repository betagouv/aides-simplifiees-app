  ...
  async run() {
    await Simulateur.updateOrCreateMany('slug', [
      ...
      },
      {
        ...
        title: 'Aides à l\'innovation pour les entreprises',
        description: 'Répondez à ces questions pour découvrir les aides à l\'innovation auxquelles votre entreprise pourrait être éligible',
        pictogramPath: '/artworks/custom-pictograms/innovation.svg',
        status: 'published',
      },
      {
        slug: 'test',
    ...
    /**
     * We might want to generate the simulateur schema dynamically in the future.
     */
    // await futureDynamicSeeder(simulateur)
  }
}

export async function futureDynamicSeeder(simulateur: Simulateur) {
