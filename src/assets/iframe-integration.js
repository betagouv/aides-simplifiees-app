...
if (typeof window === 'undefined' || typeof document === 'undefined') {
  throw new TypeError('Ce script doit être exécuté dans un navigateur')
}
...
if (!currentScript) {
  ...
  throw new TypeError('Script courant non trouvé')
}
...
if (!selectedSimulator) {
  ...
  throw new TypeError('Simulateur non spécifié')
}
