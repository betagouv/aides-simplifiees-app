  ...
  <DefaultLayout>
      ...
      <SectionContainer type="page-header">
        <h1 class="brand-contrast-text">
          <span class="brand-contrast-text--highlight">
            Vous opérez une plateforme numérique&nbsp;: </span
          ><br />intégrez un de nos simulateurs
        </h1>
      </SectionContainer>
    ...
    <BrandBackgroundContainer textured subtle>
      <SectionContainer type="page-footer">
        <hgroup>
          <h2>Vous avez un site qui informe ou accompagne les usagers ?</h2>
          <p class="fr-text--lg">
            Intégrez facilement nos simulateurs pour offrir à votre audience un accès immédiat aux
            aides disponibles.
          </p>
        </hgroup>
        <hgroup class="fr-mt-8w">
          <h3>Deux options d’intégration</h3>
          <ul class="fr-text--lg">
            <li>iFrame : Intégration simple et rapide sur votre site web.</li>
            <li>API : Personnalisation avancée</li>
          </ul>
        </hgroup>
        <div :style="{ maxWidth: '48em' }">
          <DsfrAccordionGroup :expanded-id="activeAccordion">
            ...
            >
              <p>
                Notre simulateur d'aides est intégrable de manière transparente en ajoutant une
                simple ligne de code à votre page web.
              </p>
              <p>
              ...
              <p>
                Ce script créera l'iframe adéquate dans la div que vous aurez préalablement créé et
                sur votre site.
              </p>
              <DsfrCallout>
              ...
              <div v-if="false" class="fr-form-group fr-mt-4w">
                <div class="fr-grid-row">
                  ...
                  <div class="fr-ml-8w">
                    <DsfrFieldset legend="Thème d'affichage" legend-class="fr-text--regular" inline>
                      <DsfrRadioButtonSet
              ...
              <div class="fr-p-2w fr-background-alt--grey">
                <p>Voici un aperçu de l'intégration du simulateur sur votre site :</p>
                <div id="aides-simplifiees-iframe-container" />
              </div>
              ...
              <div class="fr-my-8w">
                ...
                <p>
                  ...
                  <a href="mailto:aides.simplifiees@numerique.gouv.fr"
                    >aides.simplifiees@numerique.gouv.fr</a
                  >.
                </p>
              </div>
            </DsfrAccordion>
            ...
            >
              <p>
                L'intégration par API vous permet de personnaliser l'expérience utilisateur et de
